      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-4">
            <Reveal>
              <p className="mb-5 flex flex-wrap items-center gap-3 text-[11px] font-medium tracking-[0.24em] text-mute uppercase sm:text-[12px]">
              ...
              <p className="mt-6 text-[15px] leading-relaxed text-ink-soft">{t.lede}</p>
            </Reveal>
            ...
            <ul className="mt-10 space-y-6">
              <li className="flex items-start gap-4">
                ...
                <span className="text-[14px] leading-relaxed text-ink">
                  {dict.place.seatLine}
                  <span className="block text-[12px] text-mute">{t.plusCode(company.plusCode)}</span>
                </span>
              </li>
              <li className="flex items-start gap-4">
                ...
                <a href={`tel:${company.phoneHref}`} className="group text-[14px] text-ink transition-colors hover:text-navy-900">
                  ...
                  <span className="block text-[12px] text-mute group-hover:text-ink-soft">{t.phoneNote}</span>
                </a>
              </li>
              <li className="flex items-start gap-4">
              ...
              <li className="flex items-start gap-4">
                ...
                <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="text-[14px] text-ink transition-colors hover:text-navy-900">
                  ...
                  <span className="block text-[12px] text-mute">{t.whatsappNote}</span>
                </a>
              </li>
            </ul>
